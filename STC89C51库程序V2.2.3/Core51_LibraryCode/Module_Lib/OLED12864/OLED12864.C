...
void OLED12864_Init(void)
{
	...
	OLED12864_WriteCmd(0xAE); 
	OLED12864_WriteCmd(0x00); 
	OLED12864_WriteCmd(0x10); 
	OLED12864_WriteCmd(0x3F);
	OLED12864_WriteCmd(0x81);
	OLED12864_WriteCmd(0xCF);
	OLED12864_WriteCmd(0xA1);
	OLED12864_WriteCmd(0xC8);
	OLED12864_WriteCmd(0xA6);
	OLED12864_WriteCmd(0xA8);
	OLED12864_WriteCmd(0x3F); 
	OLED12864_WriteCmd(0xD3); 
	OLED12864_WriteCmd(0x00);
	OLED12864_WriteCmd(0xD5);
	OLED12864_WriteCmd(0x80);
	OLED12864_WriteCmd(0xD9);
	OLED12864_WriteCmd(0xF1);  
	OLED12864_WriteCmd(0xDA);
						
	OLED12864_WriteCmd(0x12);
	OLED12864_WriteCmd(0xDB);
	OLED12864_WriteCmd(0x40);
	OLED12864_WriteCmd(0x20);
	OLED12864_WriteCmd(0x02);
	OLED12864_WriteCmd(0x8D);
	OLED12864_WriteCmd(0x14);
	OLED12864_WriteCmd(0xA4);
	OLED12864_WriteCmd(0xA6);
	OLED12864_WriteCmd(0xAF);
